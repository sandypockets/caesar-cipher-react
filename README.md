...
This project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app). You can find helpful information about working with bootstrapped React apps below. 
